    ...
    <div className="justify-center items-center flex">
      ...
      <div className="container">
        ...
        <section className="relative w-full py-2">
          <div className="flex items-center justify-start py-1 px-3 mt-5">
            <h1 className='text-xl font-semibold'>NEW <span className="font-semibold text-red-900">RELEASES</span></h1>
          </div>
        ...
        <section className="py-14 lg:py-10 relative shadow-zinc-600 z-0">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
            <h3 className="max-w-2xl mx-auto font-manrope font-bold text-4xl text-gray-900 mb-5 md:text-3xl md:leading-normal">
              Discover Our Path to <span className="text-red-600">Devotion </span>
            </h3>

            <p className=" text-lg font-normal leading-7 text-gray-700 mb-9 text-justify">
