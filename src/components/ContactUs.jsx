                                    ...
                                    <ul class="mt-4">
                                        <li class="flex items-center">
                                            ...
                                            <a href="javascript:void(0)" class="text-[#007bff] text-sm ml-4">
                                                <strong>+91 9827666706</strong>
                                            </a>
                                        </li>
                                    </ul>
                                    <ul class="mt-4">
                                        <li class="flex items-center">
                                            <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-end">

                                                <svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" fill='#007bff' viewBox="0 0 479.058 479.058">
                                            ...
                                            <a href="javascript:void(0)" class="text-[#007bff] text-sm ml-4">
                                                <strong>B-6 Yashoda Gardens Bagmugaliya Bhopal-462043</strong>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
